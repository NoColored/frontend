...
export const INFO_2_DESC = {
  TITLE: '결투!',
  HEAD: '상대방의 머리를 밟아서 색을 빼앗으세요!',
  ITEM: '아이템을 먹어 단숨에 역전을 노려보세요!',
  image: {
    NO_COLORED: '/images/ui/tutorial/noColored.png',
    HIDE_SEEK: '/images/ui/tutorial/hideAndSeek.png',
  },
};
