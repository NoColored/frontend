  ...
  return (
    <div className={styles.frame}>
      <div className={styles.iconButtons}>
        <SettingIconButton
          src='/assets/ui/icon/button/icon-button-information-h50w50.png'
          alt='info'
          onClick={() => selectModalType(ModalType.info)}
        />
        <SettingIconButton
          src='/assets/ui/icon/button/icon-button-home-h50w50.png'
          alt='home'
          onClick={() => navigate('/home')}
        />
        <SettingIconButton
          src='/assets/ui/icon/button/icon-button-setting-h50w50.png'
          alt='setting'
